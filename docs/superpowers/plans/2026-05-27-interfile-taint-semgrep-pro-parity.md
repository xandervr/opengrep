...
Latest broad Docker direct scan matrix after `dc4d5d45a`:
...
Next resume point: continue auditing broader dependency-injection object-shape forms, especially rest destructuring, nested mutated containers, framework/container injection, and more complex factory composition.
